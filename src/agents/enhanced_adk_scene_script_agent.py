...
class EnhancedADKSceneScriptAgent:
    """
    Enhanced ADK-based Scene Script Writer Agent
    Uses Pydantic models for type-safe input/output and automatic ADK schema generation
    """
    
    def __init__(self):
        """Initialize Enhanced ADK Scene Script Agent"""
        ...
        logger.info("🚀 Enhanced ADK Scene Script Agent initialized with Pydantic schemas")
    ...
    async def expand_scene(self, input_data: SceneExpansionInput) -> ScenePackageOutput:
        ...
        try:
            ...
            logger.error(f"❌ Enhanced ADK Scene generation failed: {e}")
            return self._create_fallback_output(input_data, str(e))
