"""
Test the new prompt system without image generation

This script tests the completely rewritten prompts for all agents.
"""
...
async def test_new_prompts():
    ...
    try:
        ...
        print("🎯 Focus: New prompt system with strict validation")
        
        # Step 1: Generate story script with new prompts
        print("\n📖 Step 1: Generating story script with new prompts...")
        ...
        # Step 3: Generate scene scripts with new prompts (if story passed)
        if script_validation_result.status.value == "pass":
            print("\n🎬 Step 3: Generating scene scripts with new prompts...")
        ...
        print("\n✅ New prompt system test completed!")
